# SMT3HD_Reimagined_Public
dev repo, *MANY* paths and options are hardcoded, do not expect this to work for you bug free as is, this is simply in case you would like to look at the code. Many things are messy and many things are legacy/unused, this is not meant to be a 'clean release' plugin.
...
**TO ENSURE MAXIMUM COMPATABILITY, BOTH ARE NEEDED IN ORDER TO FUNCTION**
